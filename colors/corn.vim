...
endfun
" }}}
call <SID>X("Boolean","eeddaa","","none")
...
call <SID>X("Character","eeddaa","","none")
call <SID>X("Comment","bbccee","","none")
call <SID>X("Conditional","e2e4e5","","none")
call <SID>X("Constant","eeddaa","","none")
call <SID>X("Cursor","000000","f0f0f0","none")
...
call <SID>X("DiffAdd","e0e0e0","","none")
call <SID>X("DiffChange","e0e0e0","","none")
call <SID>X("DiffDelete","e0e0e0","","none")
call <SID>X("DiffText","eeddaa","","none")
...
call <SID>X("ErrorMsg","e0e0e0","","none")
call <SID>X("Exception","e2e4e5","","none")
call <SID>X("Float","eeddaa","","none")
call <SID>X("FoldColumn","e2e4e5","","none")
call <SID>X("Folded","c0c0c0","808080","none")
call <SID>X("Function","ccee00","","italic")
call <SID>X("Identifier","e0e0e0","333333","none")
call <SID>X("Ignore","e0e0e0","333333","none")
call <SID>X("IncSearch","e2e4e5","","none")
call <SID>X("Include","e2e4e5","","none")
call <SID>X("Keyword","ccee00","","none")
...
call <SID>X("ModeMsg","e0e0e0","","none")
call <SID>X("MoreMsg","e2e4e5","","none")
call <SID>X("NonText","cccccc","","none")
call <SID>X("Normal","e0e0e0","333333","none")
call <SID>X("Number","eeddaa","","none")
call <SID>X("Operator","ccee00","","none")
call <SID>X("PMenu","c0c0c0","000000","none")
call <SID>X("PMenuSbar","c0c0c0","848688","none")
call <SID>X("PMenuSel","b8860b","e5e5e5","none")
call <SID>X("PMenuThumb","c0c0c0","cccccc","none")
call <SID>X("PreCondit","e2e4e5","","none")
call <SID>X("PreProc","ccee00","","none")
call <SID>X("Question","e0e0e0","","none")
call <SID>X("Repeat","e2e4e5","","none")
call <SID>X("Search","e2e4e5","","none")
call <SID>X("SignColumn","e2e4e5","","none")
call <SID>X("Special","ccee00","","none")
...
call <SID>X("Statement","ccee00","","italic")
call <SID>X("StatusLine","b8860b","e5e5e5","none")
call <SID>X("StatusLineNC","c0c0c0","000000","none")
call <SID>X("StorageClass","e2e4e5","","none")
call <SID>X("String","eeddaa","","none")
...
call <SID>X("Title","e0e0e0","333333","none")
call <SID>X("Todo","ffffff","ff0000","none")
call <SID>X("Type","ccee00","","none")
call <SID>X("Typedef","e2e4e5","","none")
call <SID>X("Underlined","e0e0e0","","underline")
call <SID>X("Union","e2e4e5","","none")
call <SID>X("VertSplit","eeeeee","","none")
call <SID>X("Visual","c0c0c0","000000","none")
call <SID>X("VisualNOS","e2e4e5","","none")
call <SID>X("WarningMsg","e2e4e5","","none")
call <SID>X("WildMenu","e2e4e5","","none")
call <SID>X("pythonBuiltin","e0e0e0","","none")
