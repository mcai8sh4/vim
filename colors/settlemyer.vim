...
call <SID>X("Character","00ff7f","","none")
call <SID>X("Comment","ffb6c1","","none")
call <SID>X("Conditional","87ceeb","","none")
call <SID>X("Constant","00ff7f","","none")
call <SID>X("Cursor","d9d9d9","cd0000","none")
call <SID>X("CursorColumn","e2e4e5","","none")
call <SID>X("CursorLine","e2e4e5","","none")
call <SID>X("Debug","e2e4e5","","none")
call <SID>X("Define","87ceeb","","none")
call <SID>X("DefinedName","e2e4e5","","none")
call <SID>X("Delimiter","e2e4e5","","none")
call <SID>X("DiffAdd","d9d9d9","","none")
call <SID>X("DiffChange","d9d9d9","","none")
call <SID>X("DiffDelete","d9d9d9","","none")
call <SID>X("DiffText","00ff7f","","none")
...
call <SID>X("ErrorMsg","d9d9d9","","none")
call <SID>X("Exception","e2e4e5","","none")
call <SID>X("Float","00ff7f","","none")
call <SID>X("FoldColumn","e2e4e5","","none")
call <SID>X("Folded","e2e4e5","","none")
call <SID>X("Function","87ceeb","","none")
call <SID>X("Identifier","d9d9d9","","none")
call <SID>X("Ignore","e2e4e5","","none")
call <SID>X("IncSearch","e2e4e5","","none")
call <SID>X("Include","87ceeb","","none")
call <SID>X("Keyword","87ceeb","","none")
call <SID>X("Label","87ceeb","","none")
call <SID>X("LineNr","d9d9d9","","none")
call <SID>X("LocalVariable","e2e4e5","","none")
call <SID>X("Macro","87ceeb","","none")
call <SID>X("MatchParen","e2e4e5","","none")
call <SID>X("ModeMsg","d9d9d9","","none")
call <SID>X("MoreMsg","e2e4e5","","none")
call <SID>X("NonText","a9a9a9","","none")
call <SID>X("Normal","d9d9d9","404040","none")
call <SID>X("Number","00ff7f","","none")
call <SID>X("Operator","87ceeb","","none")
call <SID>X("PMenu","ffffff","545658","none")
call <SID>X("PMenuSbar","ffffff","848688","none")
call <SID>X("PMenuSel","88dd88","949698","none")
call <SID>X("PMenuThumb","ffffff","a4a6a8","none")
call <SID>X("PreCondit","87ceeb","","none")
call <SID>X("PreProc","87ceeb","","none")
call <SID>X("Question","d9d9d9","","none")
call <SID>X("Repeat","87ceeb","","none")
call <SID>X("Search","e2e4e5","","none")
call <SID>X("SignColumn","e2e4e5","","none")
call <SID>X("Special","d9d9d9","","none")
...
call <SID>X("Statement","87ceeb","","none")
call <SID>X("StatusLine","d9d9d9","","none")
call <SID>X("StatusLineNC","d9d9d9","","none")
call <SID>X("StorageClass","87ceeb","","bold")
call <SID>X("String","d9d9d9","","none")
call <SID>X("Structure","87ceeb","","bold")
...
call <SID>X("Todo","d9d9d9","","none")
call <SID>X("Type","87ceeb","","bold")
call <SID>X("Typedef","87ceeb","","bold")
...
call <SID>X("pythonBuiltin","d9d9d9","","none")
